...
model_filename = r'E:\datas\Singapore-housing-price-prediction-main\resale_price_prediction_decision_tree.joblib'
...
if os.path.exists(model_filename):
    ...
    print("The model file does not exist in the specified path.")

# Streamlit app title
st.markdown("<h1 style='color: red;'>Resale Price Prediction App 💻</h1>", unsafe_allow_html=True)
...
# Define home page
def home():
    st.markdown("<h2 style='color: blue;'>About</h2>", unsafe_allow_html=True)
    st.write("""
    This project predicts Singapore resale flat prices using machine learning. 
    It encompasses data preprocessing, EDA, and models like Linear Regression. 
    With a focus on informing real estate decisions, it provides valuable insights into the dynamic Singapore housing market.
    """)

# Define explore data page
def explore_data():
...
# Define page content based on the user selection
if SELECT == "Home 🏠":
    home()
